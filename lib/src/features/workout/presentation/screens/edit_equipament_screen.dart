...
class _EditEquipmentScreenState extends State<EditEquipmentScreen> {
  ...
  void initState() {
    ...
    _muscleGroups = List.from(widget.equipment.muscleGroups);
    _exercises = List.from(widget.equipment.exercises);
  }
  ...
  Future<void> _updateEquipment() async {
    if (_formKey.currentState!.validate() &&
      ...
      try {
        String? imageUrl = widget.equipment.imageUrl;
        if (_imageFile != null) {
          // Upload new image to Firebase Storage
          final storageRef = FirebaseStorage.instance
              .ref()
              .child('equipment_images')
              .child(widget.equipment.userId)
          ...
          if (widget.equipment.imageUrl != null) {
            try {
              await FirebaseStorage.instance
                  .refFromURL(widget.equipment.imageUrl!)
                  .delete();
            } catch (e) {
        ...
        context.read<EquipmentBloc>().add(UpdateEquipment(updatedEquipment));
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isUploading ? null : _updateEquipment,
